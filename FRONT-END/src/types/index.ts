...
export type GlobalContext = { tenantId:string; productId:string; productName:string; environment:string; selectedRelease:string; comparisonRelease?:string; userRole:string; theme:Theme };
